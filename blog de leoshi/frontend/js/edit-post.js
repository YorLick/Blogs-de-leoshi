document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!postId) {
        document.querySelector('.content').innerHTML = '<h1>Error: No se especificó un ID de post para editar.</h1>';
        return;
    }
    ...
    form.addEventListener('submit', (e) => {
        ...
        .then(data => {
            ...
            setTimeout(() => { window.location.href = `post.html?id=${postId}`; }, 2000);
        })
        .catch(error => {
